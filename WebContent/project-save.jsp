                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="${ pageContext.request.contextPath }/project_save.action" method="post">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">项目名 / ProjectName</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="projectName" placeholder="请输入项目名 / ProjectName">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="5" id="user-intro" name="projectIntro" placeholder="请输入项目简介"></textarea>
                                    </div>
                                </div>
