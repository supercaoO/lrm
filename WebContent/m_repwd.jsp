	...
	<div class="am-g myapp-login">
		<div class="myapp-login-logo-block  tpl-login-max">
			...
			<div class="am-u-sm-10 login-am-center">
				<form class="am-form"
					action="${ pageContext.request.contextPath }/manager_repwd.action"
					method="post" onsubmit="return checkNewPwd()">
					<fieldset>
						...
						<div class="am-form-group">
							<input type="password" name="managerPassword" class=""
								id="doc-ipt-pwd-1" placeholder="请输入原密码">
						</div>
					</fieldset>
					<fieldset>
						<div class="am-form-group">
							<input type="password" id="doc-ipt-email-11"
								name="newManagerPassword" class="" placeholder="请输入新密码">
						</div>
						<div class="am-form-group">
							<input type="password" id="doc-ipt-pwd-11"
								name="confirmManagerPassword" class=""
								placeholder="请再次输入新密码，并点击检查按钮确认无误">
						</div>
						<p>
