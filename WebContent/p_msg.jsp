		...
		<div class="tpl-content-wrapper">
			...
			<div class="tpl-content-scope">
				<div class="note note-info">
					...
					<p>
						最近修改时间：
						<s:property value="lastCommitDate" />
					</p>
					<hr>
					<p>
						<span class="label label-danger">负责人</span>
						<s:property value="manager.managerName" />
					</p>
					<hr>
					<p>
						<span class="label label-danger">项目组成员</span>
					...
					<hr>
					<p>
						<span class="label label-danger">项目简介</span>
						<s:property value="projectIntro" />
					</p>
				</div>
			</div>
		</div>
