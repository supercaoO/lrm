                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="${ pageContext.request.contextPath }/manager_save.action" method="post">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">管理员姓名 / ManagerName</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" name="managerName" placeholder="请输入姓名 / ManagerName">
                                    </div>
                                </div>
