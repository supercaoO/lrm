	...
	<div class="am-g myapp-login">
		<div class="myapp-login-logo-block  tpl-login-max">
			...
			<div class="am-u-sm-10 login-am-center">
				<form class="am-form"
					action="${ pageContext.request.contextPath }/student_login.action"
					method="post" onsubmit="return checkInput()">
					<fieldset>
						<div class="am-form-group">
							<input type="text" name="studentId" class="" id="doc-ipt-email-1"
								placeholder="请输入学号">
						</div>
						<div class="am-form-group">
							<input type="password" name="studentPassword" class=""
