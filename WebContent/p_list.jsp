									...
									<tbody>
										...
										<s:iterator value="projectPage.pages">
											<tr>
												...
												<td class="am-hide-sm-only"><s:property
														value="lastCommitDate" /></td>
												<td>
													<div class="am-btn-toolbar">
														<div class="am-btn-group am-btn-group-xs">
															<a
																href="${ pageContext.request.contextPath }/project_queryStudents.action?projectId=${ projectId }">
																<button type="button"
																	class="am-btn am-btn-default am-btn-xs am-text-secondary">
																	<span class="am-icon-pencil-square-o"></span> 查看成员
																</button>
															</a> <a
																href="${ pageContext.request.contextPath }/manager_listWithProjectId.action?projectId=${ projectId }&projectName=${ projectName }&thisManagerId=${ manager.managerId }&thisManagerName=${ manager.managerName }">
																<button type="button"
																	class="am-btn am-btn-default am-btn-xs am-text-secondary">
																	<span class="am-icon-pencil-square-o"></span> 编辑
																</button>
															</a> <a
																href="${ pageContext.request.contextPath }/project_delete.action?projectId=${ projectId }">
																<button type="button"
																	class="am-btn am-btn-default am-btn-xs am-text-secondary">
