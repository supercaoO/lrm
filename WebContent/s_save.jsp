			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span> 添加成员
					</div>
					...
					<div class="am-g tpl-amazeui-form">
						...
						<div class="am-u-sm-12 am-u-md-9">
							<form class="am-form am-form-horizontal"
								action="${ pageContext.request.contextPath }/student_save.action"
								method="post">
								<div class="am-form-group">
									<label for="user-name" class="am-u-sm-3 am-form-label">成员学号
										/ StudentId</label>
									<div class="am-u-sm-9">
										<input type="text" id="user-name" name="studentId"
											placeholder="请输入成员学号 / StudentId">
									</div>
								</div>

								<div class="am-form-group">
									<label for="user-name" class="am-u-sm-3 am-form-label">成员姓名
										/ StudentName</label>
									<div class="am-u-sm-9">
										<input type="text" id="user-name" name="studentName"
											placeholder="请输入成员姓名 / StudentName">
									</div>
								</div>

								<div class="am-form-group">
									<label for="user-email" class="am-u-sm-3 am-form-label">所属项目
										/ Project</label>
									<div class="am-u-sm-9">
										<select
											<%-- data-am-selected="{btnSize: 'sm'}" --%> name="projectId">
											<s:iterator value="projectList">
												<option value="${ projectId }"><s:property
